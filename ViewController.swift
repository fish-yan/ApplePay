...
class ViewController: UIViewController, PKPaymentAuthorizationViewControllerDelegate {
	...
	func buyNowButtonTapped(sender: UIButton) {
		...
		if PKPaymentAuthorizationViewController.canMakePaymentsUsingNetworks(paymentNetworks) {
			...
			request.countryCode = "CN" // Standard ISO country code. The country in which you make the charge.
			request.currencyCode = "CNY" // Standard ISO currency code. Any currency you like.
